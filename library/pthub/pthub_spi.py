...
def _add_state_change_to_send_to_stack(state_change_to_send_type, state_change_to_send_operation):
    pending_state_change_to_send = StateChange(state_change_to_send_type, state_change_to_send_operation)
...
def _main_thread_loop():
    ...
    PTLogger.info("Hub v1 main loop exited. Sending " + str(len(_spi_handler.queued_changes)) + " remaining queued changes...")
